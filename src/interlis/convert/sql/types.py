"""INTERLIS attribute type -> SQL column type mapping: scalar types and geometry (SFA/PostGIS) columns.

A pure leaf module (only `tables.py` calls into it) - no other submodule
of this package needed to build it.
"""

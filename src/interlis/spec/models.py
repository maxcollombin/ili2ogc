...
Single schema shared between static mapping validation and the
ModelBuilder's execution (interlis.builder) - one single definition of
"what a mapping entry looks like", so the two never drift apart over
time.
"""
